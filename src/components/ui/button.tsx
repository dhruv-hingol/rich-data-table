...
export function Button({
  ...
  const variants = {
    primary:
      "bg-[#ff6600] hover:bg-[#e55c00] text-white font-semibold shadow-2xs",
    secondary:
      "bg-slate-100 hover:bg-slate-200 text-slate-800 border border-slate-300 font-semibold",
    outline:
      "border border-slate-300 text-slate-800 bg-white hover:border-[#ff6600] hover:text-[#ff6600] hover:bg-orange-50/50 font-semibold shadow-2xs",
